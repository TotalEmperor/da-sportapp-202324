        ...
        <>
            <div
                ...
                <div className="flex-1 flex justify-center items-center">
                    ...
                    <div className="rounded-3xl p-2 bg-white min-h-fit max-h-screen w-1/4">
                                ...
                                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 flex-grow">
                                    ...
                                    <div className="col-span-full flex flex-col justify-center items-center">
                                        <div className="min-w-fit w-10/12 my-2">
                                            ...
                                            <label htmlFor="1"
                                                   className="block cursor-pointer border-2 text-black select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">1</label>
                                        </div>
                                        <div className="min-w-fit w-10/12 my-2">
                                            <input type="radio" name="option" id="2" value="2" className="peer hidden"/>
                                            <label htmlFor="2"
                                                   className="block cursor-pointer border-2 text-black select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">2</label>
                                        </div>
                                        <div className="min-w-fit w-10/12 my-2">
                                            <input type="radio" name="option" id="3" value="3" className="peer hidden"/>
                                            <label htmlFor="3"
                                                   className="block cursor-pointer border-2 text-black select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">3</label>
                                        </div>
                                        <div className="min-w-fit w-10/12 my-2">
                                            <input type="radio" name="option" id="4" value="4" className="peer hidden"/>
                                            <label htmlFor="4"
                                                   className="block cursor-pointer border-2 text-black select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">I
                                                am doing my own</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
