...
export default function AccountDropdown() {
  ...
  // Signs out the user and redirects him to the landing page
  ...
  // Signs out the user and redirect him to the SignIn page
  const handleSignInIntoNewAccount = async (event)=>{
      event.preventDefault()
            ...
            >
                            <span className="sm:inline font-medium text-[1.5rem] w-full">
                                <AccountCircleOutlinedIcon
                                  className={"icons sm:mx-2 mx-4 inline"}></AccountCircleOutlinedIcon>{getAuth().currentUser.displayName}
                            </span>
            </button>
          </div>
